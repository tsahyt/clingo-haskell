...
newtype ClingoWarning = MkClingoWarning CInt
    deriving (Show, Eq)
...
newtype TruthValue = MkTruthValue CInt
    deriving (Show, Eq)
...
newtype SymbolType = MkSymbolType CInt
    deriving (Show, Eq)
...
newtype ModelType = MkModelType CInt
    deriving (Show, Eq)
...
newtype TheoryTerm = MkTheoryTerm CInt
    deriving (Show, Eq)
...
newtype ClauseType = MkClauseType CInt
    deriving (Show, Eq)
...
newtype HeuristicType = MkHeuristicType CInt
    deriving (Show, Eq)
...
newtype ExternalType = MkExternalType CInt
    deriving (Show, Eq)
...
newtype StatisticsType = MkStatisticsType CInt
    deriving (Show, Eq)
